...
/**
 * Created by byfieldj on 9/27/15.
 */
 ...
 */
public class PickYelpPlaceInviteFragment extends Fragment {
    ...
    public PickYelpPlaceInviteFragment() {
        // Required empty public constructor
    }

    public static PickYelpPlaceInviteFragment newInstance(YelpPlace place) {
        PickYelpPlaceInviteFragment pickYelpPlaceInviteFragment = new PickYelpPlaceInviteFragment();
        Bundle bundle = new Bundle();
        bundle.putSerializable(PLACE_FOR_INVITE, place);
        pickYelpPlaceInviteFragment.setArguments(bundle);
        return pickYelpPlaceInviteFragment;
    }
